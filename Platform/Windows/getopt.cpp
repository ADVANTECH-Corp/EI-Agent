...
WISEPLATFORM_API char *getoptarg() { return _optarg; }
WISEPLATFORM_API int getoptind() { return _optind; }

/*
* getopt --
*      Parse argc/argv argument vector.
*/
WISEPLATFORM_API int getopt(int nargc, char * const nargv[], const char *ostr)
{
