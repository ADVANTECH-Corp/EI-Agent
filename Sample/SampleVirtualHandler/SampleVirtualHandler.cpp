...
/****************************************************************************/
#include "platform.h"
#include "SampleVirtualHandler.h"
#include <stdio.h>

//-----------------------------------------------------------------------------
// Variables
//-----------------------------------------------------------------------------
Handler_info_ex *pluginfo_ex = NULL;
...
int HANDLER_API Handler_Start( void )
{
	...
	pluginfo_ex->addvirtualhandlercbf("RFID_Handler",pluginfo_ex->Name);
	pluginfo_ex->addvirtualhandlercbf("GPS_Handler",pluginfo_ex->Name);
	return handler_success;
}
