...
/*H*/ADVLOG_EXPORT void ADVLOG_CALL AdvLog_VPrint(char *confname, int level, int color, const char *file, const char *func, const char *line, const char* levels, const char *fmt, va_list ap);
/*I*/ADVLOG_EXPORT void ADVLOG_CALL AdvLog_VWrite(char *confname, int level, const char *color, const char *colorend, const char *file, const char *func, const char *line, const char* levels, const char *fmt, va_list ap);
/*J*/ADVLOG_EXPORT void ADVLOG_CALL AdvLog_VPrintAndWrite(char *confname, int level, int color, const char *colorstr, const char *colorend, const char *file, const char *func, const char *line, const char* levels, const char *fmt, va_list ap);
